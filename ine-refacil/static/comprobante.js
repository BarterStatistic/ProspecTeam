/* Comprobante de captura: se dibuja en un canvas y se baja como PNG.
   Paleta propia, distinta a la de la app: fondo blanco, azul y amarillo vibrante.
   El amarillo nunca lleva texto encima; sobre blanco no alcanza contraste legible. */
...
const LIENZO = { ancho: 1240, alto: 1754 };
const MARGEN = 88;
 ...
 * datos: { nombreCompleto, rfc, fecha }  ·  imagen: HTMLImageElement o null
 */
function dibujarComprobante(lienzo, datos, imagen) {
  ...
  dibujarDato(ctx, 'FECHA DE CAPTURA', fechaLarga(datos.fecha), y, { tam: 34 });
...
function descargarComprobante(lienzo, datos) {
